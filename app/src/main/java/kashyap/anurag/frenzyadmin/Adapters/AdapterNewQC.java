...
public class AdapterNewQC extends RecyclerView.Adapter<AdapterNewQC.HolderNewQC> {

    private Context context;
    private ArrayList<ModelNewQC> newQCArrayList;

    public AdapterNewQC(Context context, ArrayList<ModelNewQC> newQCArrayList) {
    ...
    @NonNull
    @Override
    public HolderNewQC onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.row_produt_qc_item, parent, false);
        return new HolderNewQC(view);
    }

    @Override
    public void onBindViewHolder(@NonNull HolderNewQC holder, int position) {
    ...
    private void loadShopDetails(String shopId, HolderNewQC holder) {
    ...
    private void loadProductDetails(String productId, HolderNewQC holder) {
            ...
            public void onEvent(@Nullable DocumentSnapshot snapshot, @Nullable FirebaseFirestoreException error) {
                ...
                holder.itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        intent.putExtra("BUTTON_CODE", "SHOW");
    ...
    public class HolderNewQC extends RecyclerView.ViewHolder {

        private ImageView productImage;
        private TextView categoryTv, productTitle, dateTv, shopNameTv;

        public HolderNewQC(@NonNull View itemView) {
            super(itemView);
